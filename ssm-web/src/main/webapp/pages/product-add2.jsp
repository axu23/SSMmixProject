        ...
        <form id="productForm">
            ...
            <section class="content"> <!--产品信息-->
                ...
                <div class="box-tools text-center">
                    <a class="btn bg-maroon" id="save">保存</a>
...
<script>
    ...
    $(function () {
        ...
        $("#save").click(function(){
            ...
            var $departureTime = $("#datepicker-a3").val();
            ...
            $.ajax({
                ...
                type: "post",
                data:'{"productNum":"' + $productNum + '","productName":"' + $productName + '","departureTime":"' + $departureTime + '","cityName":"' + $cityName + '","productPrice":"' + $productPrice + '","productStatus":"' + $productStatus + '","productDesc":"' + $productDesc + '"}',
                success: function (data) {
                    console.log(data);
                    if (data == "success") {
                        location.href = "${pageContext.request.contextPath}>/product/findAll.do";
                    } else if (data == "error") {
                        location.href = "saveError.jsp";
                    } else {
